...
function UserForm({ user, setUser }) {
    ...
    const handleForm = async () => {
            if(!user.employee_id){ //If the employee ID is blank, a new user is being added.
                try {
                    const newUser = { is_admin: isAdmin, is_driver: isDriver, employee_first_name: user.employee_first_name, employee_last_name: user.employee_last_name, 
            ...
            <div className="form-container">
                ...
                <form className='employee-details' data-transport-order="form">
                    <div className='form-group'>
                        ...
                        <input className="form-control" id="UserAddress" value={user.employee_street_address}></input>
                        <label htmlFor='UserCity'> CITY</label>
                        <input className="form-control" id="UserCity"  value={user.employee_city}></input>
                        <label htmlFor='UserState'>STATE</label>
                        <input className="form-control" id="UserState"  value={user.employee_state}></input>
                        <label htmlFor='UserZip'>ZIP CODE</label>
                        <input className="form-control" id="UserZip"  value={user.employee_zip_code}></input>
                        <label htmlFor='UserEmail'>EMAIL</label>
                        <input type="email" placeholder="example@gmail/yahoo.com" pattern=".+@(gmail|yahoo)\.com" className="form-control" id="UserEmail" value={user.employee_email}></input>
                    </div>
                    <Form>
                    {
